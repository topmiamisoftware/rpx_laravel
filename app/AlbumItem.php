...
class AlbumItem extends Model
{
    ...
    public function likes(){
        return $this->hasMany('App\AlbumItemLike', 'album_media_id');
    }

    public function user(){
        return $this->belongsTo('App\User', 'media_owner_user_id');
    }

    public function spotbieUser(){
        return $this->belongsTo('App\SpotbieUser', 'media_owner_user_id');
    }
